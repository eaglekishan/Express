...
class PostViewAdapterProfile(private val postcard:List<PostShow>, private val context: Context,):RecyclerView.Adapter<PostViewAdapterProfile.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v=LayoutInflater.from(parent.context).inflate(R.layout.postcardprofile,parent,false)
        return ViewHolder(v)
    }
